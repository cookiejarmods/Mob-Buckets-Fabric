...
public class OcelotBucketItem extends Item {
    ...
    public static final EntityType<OcelotEntity> MOB_ENTITY_TYPE = EntityType.OCELOT;
    ...
    public ActionResult useOnBlock(ItemUsageContext context) {
        ...
        if (!world.isClient) {
            ...
            // spawn the mob
            OcelotEntity mob = spawn(MOB_ENTITY_TYPE, (ServerWorld)world, spawnPos, SpawnReason.BUCKET);
            if (mob != null) {
