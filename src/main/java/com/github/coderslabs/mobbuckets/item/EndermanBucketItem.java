...
public class EndermanBucketItem extends Item {
    ...
    public static final EntityType<EndermanEntity> MOB_ENTITY_TYPE = EntityType.ENDERMAN;
    ...
    public ActionResult useOnBlock(ItemUsageContext context) {
        ...
        if (!world.isClient) {
            ...
            // spawn the mob
            EndermanEntity mob = spawn(MOB_ENTITY_TYPE, (ServerWorld)world, spawnPos, SpawnReason.BUCKET);
            if (mob != null) {
