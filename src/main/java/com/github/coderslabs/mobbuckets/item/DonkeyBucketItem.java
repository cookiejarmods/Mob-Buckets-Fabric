...
public class DonkeyBucketItem extends Item {
    ...
    public static final EntityType<DonkeyEntity> MOB_ENTITY_TYPE = EntityType.DONKEY;
    ...
    public ActionResult useOnBlock(ItemUsageContext context) {
        ...
        if (!world.isClient) {
            ...
            // spawn the mob
            DonkeyEntity mob = spawn(MOB_ENTITY_TYPE, (ServerWorld)world, spawnPos, SpawnReason.BUCKET);
            if (mob != null) {
