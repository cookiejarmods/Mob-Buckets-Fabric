...
public class CreeperBucketItem extends Item {
    ...
    public static final EntityType<CreeperEntity> MOB_ENTITY_TYPE = EntityType.CREEPER;
    ...
    public ActionResult useOnBlock(ItemUsageContext context) {
        ...
        if (!world.isClient) {
            ...
            // spawn the mob
            CreeperEntity mob = spawn(MOB_ENTITY_TYPE, (ServerWorld)world, spawnPos, SpawnReason.BUCKET);
            if (mob != null) {
