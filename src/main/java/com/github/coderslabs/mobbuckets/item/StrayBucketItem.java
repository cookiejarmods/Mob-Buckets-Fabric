...
public class StrayBucketItem extends Item {
    public static final String STORED_MOB = "stored_mob";
    public static final EntityType<StrayEntity> MOB_ENTITY_TYPE = EntityType.STRAY;

    public StrayBucketItem(Settings settings) {
        super(settings);
    }
    ...
    public ActionResult useOnBlock(ItemUsageContext context) {
        ...
        if (!world.isClient) {
            ...
            // spawn the mob
            StrayEntity mob = spawn(MOB_ENTITY_TYPE, (ServerWorld)world, spawnPos, SpawnReason.BUCKET);
            if (mob != null) {
