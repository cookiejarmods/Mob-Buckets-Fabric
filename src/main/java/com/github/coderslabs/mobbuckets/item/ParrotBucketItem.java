...
public class ParrotBucketItem extends Item {
    ...
    public static final EntityType<ParrotEntity> MOB_ENTITY_TYPE = EntityType.PARROT;
    ...
    public ActionResult useOnBlock(ItemUsageContext context) {
        ...
        if (!world.isClient) {
            ...
            // spawn the mob
            ParrotEntity mob = spawn(MOB_ENTITY_TYPE, (ServerWorld)world, spawnPos, SpawnReason.BUCKET);
            if (mob != null) {
