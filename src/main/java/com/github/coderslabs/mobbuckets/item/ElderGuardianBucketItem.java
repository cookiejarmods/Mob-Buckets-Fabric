...
public class ElderGuardianBucketItem extends Item {
    public static final String STORED_MOB = "stored_mob";
    public static final EntityType<ElderGuardianEntity> MOB_ENTITY_TYPE = EntityType.ELDER_GUARDIAN;

    public ElderGuardianBucketItem(Settings settings) {
        super(settings);
    }
    ...
    public ActionResult useOnBlock(ItemUsageContext context) {
        ...
        if (!world.isClient) {
            ...
            // spawn the mob
            ElderGuardianEntity mob = spawn(MOB_ENTITY_TYPE, (ServerWorld)world, spawnPos, SpawnReason.BUCKET);
            if (mob != null) {
