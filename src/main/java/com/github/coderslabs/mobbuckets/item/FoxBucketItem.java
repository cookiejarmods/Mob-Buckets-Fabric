...
public class FoxBucketItem extends Item {
    ...
    public static final EntityType<FoxEntity> MOB_ENTITY_TYPE = EntityType.FOX;
    ...
    public ActionResult useOnBlock(ItemUsageContext context) {
        ...
        if (!world.isClient) {
            ...
            // spawn the mob
            FoxEntity mob = spawn(MOB_ENTITY_TYPE, (ServerWorld)world, spawnPos, SpawnReason.BUCKET);
            if (mob != null) {
