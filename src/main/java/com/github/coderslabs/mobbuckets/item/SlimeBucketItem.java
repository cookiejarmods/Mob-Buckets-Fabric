...
public class SlimeBucketItem extends Item {
    ...
    public static final EntityType<SlimeEntity> MOB_ENTITY_TYPE = EntityType.SLIME;
    ...
    public ActionResult useOnBlock(ItemUsageContext context) {
        ...
        if (!world.isClient) {
            ...
            // spawn the mob
            SlimeEntity mob = spawn(MOB_ENTITY_TYPE, (ServerWorld)world, spawnPos, SpawnReason.BUCKET);
            if (mob != null) {
