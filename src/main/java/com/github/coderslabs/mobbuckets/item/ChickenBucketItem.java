...
public class ChickenBucketItem extends Item {
    ...
    public static final EntityType<ChickenEntity> MOB_ENTITY_TYPE = EntityType.CHICKEN;

    public ChickenBucketItem(Settings settings) {
        super(settings);
    }
    ...
    public ActionResult useOnBlock(ItemUsageContext context) {
        ...
        if (!world.isClient) {
            ...
            // spawn the mob
            ChickenEntity mob = spawn(MOB_ENTITY_TYPE, (ServerWorld)world, spawnPos, SpawnReason.BUCKET);
            if (mob != null) {
