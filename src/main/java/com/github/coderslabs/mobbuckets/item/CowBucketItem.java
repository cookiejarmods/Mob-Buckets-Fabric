...
public class CowBucketItem extends Item {
    ...
    public static final EntityType<CowEntity> MOB_ENTITY_TYPE = EntityType.COW;
    ...
    public ActionResult useOnBlock(ItemUsageContext context) {
        ...
        if (!world.isClient) {
            ...
            // spawn the mob
            CowEntity mob = spawn(MOB_ENTITY_TYPE, (ServerWorld)world, spawnPos, SpawnReason.BUCKET);
            if (mob != null) {
