...
public class IronGolemBucketItem extends Item {
    ...
    public static final EntityType<IronGolemEntity> MOB_ENTITY_TYPE = EntityType.IRON_GOLEM;
    ...
    public ActionResult useOnBlock(ItemUsageContext context) {
        ...
        if (!world.isClient) {
            ...
            // spawn the mob
            IronGolemEntity mob = spawn(MOB_ENTITY_TYPE, (ServerWorld)world, spawnPos, SpawnReason.BUCKET);
            if (mob != null) {
