...
public class WitchBucketItem extends Item {
    public static final String STORED_MOB = "stored_mob";
    public static final EntityType<WitchEntity> MOB_ENTITY_TYPE = EntityType.WITCH;

    public WitchBucketItem(Settings settings) {
        super(settings);
    }
    ...
    public ActionResult useOnBlock(ItemUsageContext context) {
        ...
        if (!world.isClient) {
            ...
            // spawn the mob
            WitchEntity mob = spawn(MOB_ENTITY_TYPE, (ServerWorld)world, spawnPos, SpawnReason.BUCKET);
            if (mob != null) {
