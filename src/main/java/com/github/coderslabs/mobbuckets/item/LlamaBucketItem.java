...
public class LlamaBucketItem extends Item {
    ...
    public static final EntityType<LlamaEntity> MOB_ENTITY_TYPE = EntityType.LLAMA;
    ...
    public ActionResult useOnBlock(ItemUsageContext context) {
        ...
        if (!world.isClient) {
            ...
            // spawn the mob
            LlamaEntity mob = spawn(MOB_ENTITY_TYPE, (ServerWorld)world, spawnPos, SpawnReason.BUCKET);
            if (mob != null) {
