...
public class WolfBucketItem extends Item {
    ...
    public static final EntityType<WolfEntity> MOB_ENTITY_TYPE = EntityType.WOLF;
    ...
    public ActionResult useOnBlock(ItemUsageContext context) {
        ...
        if (!world.isClient) {
            ...
            // spawn the mob
            WolfEntity mob = spawn(MOB_ENTITY_TYPE, (ServerWorld)world, spawnPos, SpawnReason.BUCKET);
            if (mob != null) {
