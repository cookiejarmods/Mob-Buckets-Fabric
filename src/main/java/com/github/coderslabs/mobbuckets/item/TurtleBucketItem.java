...
public class TurtleBucketItem extends Item {
    ...
    public static final EntityType<TurtleEntity> MOB_ENTITY_TYPE = EntityType.TURTLE;
    ...
    public ActionResult useOnBlock(ItemUsageContext context) {
        ...
        if (!world.isClient) {
            ...
            // spawn the mob
            TurtleEntity mob = spawn(MOB_ENTITY_TYPE, (ServerWorld)world, spawnPos, SpawnReason.BUCKET);
            if (mob != null) {
