...
public class MuleBucketItem extends Item {
    ...
    public static final EntityType<MuleEntity> MOB_ENTITY_TYPE = EntityType.MULE;
    ...
    public ActionResult useOnBlock(ItemUsageContext context) {
        ...
        if (!world.isClient) {
            ...
            // spawn the mob
            MuleEntity mob = spawn(MOB_ENTITY_TYPE, (ServerWorld)world, spawnPos, SpawnReason.BUCKET);
            if (mob != null) {
