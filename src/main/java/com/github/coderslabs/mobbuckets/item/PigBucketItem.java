...
public class PigBucketItem extends Item {
    ...
    public static final EntityType<PigEntity> MOB_ENTITY_TYPE = EntityType.PIG;
    ...
    public ActionResult useOnBlock(ItemUsageContext context) {
        ...
        if (!world.isClient) {
            ...
            // spawn the mob
            PigEntity mob = spawn(MOB_ENTITY_TYPE, (ServerWorld)world, spawnPos, SpawnReason.BUCKET);
            if (mob != null) {
