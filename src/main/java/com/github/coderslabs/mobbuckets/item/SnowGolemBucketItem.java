...
public class SnowGolemBucketItem extends Item {
    ...
    public static final EntityType<SnowGolemEntity> MOB_ENTITY_TYPE = EntityType.SNOW_GOLEM;
    ...
    public ActionResult useOnBlock(ItemUsageContext context) {
        ...
        if (!world.isClient) {
            ...
            // spawn the mob
            SnowGolemEntity mob = spawn(MOB_ENTITY_TYPE, (ServerWorld)world, spawnPos, SpawnReason.BUCKET);
            if (mob != null) {
