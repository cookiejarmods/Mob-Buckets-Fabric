...
public class DrownedBucketItem extends Item {
    public static final String STORED_MOB = "stored_mob";
    public static final EntityType<DrownedEntity> MOB_ENTITY_TYPE = EntityType.DROWNED;

    public DrownedBucketItem(Settings settings) {
        super(settings);
    }
    ...
    public ActionResult useOnBlock(ItemUsageContext context) {
        ...
        if (!world.isClient) {
            ...
            // spawn the mob
            DrownedEntity mob = spawn(MOB_ENTITY_TYPE, (ServerWorld)world, spawnPos, SpawnReason.BUCKET);
            if (mob != null) {
