...
public class SkeletonBucketItem extends Item {
    public static final String STORED_MOB = "stored_mob";
    public static final EntityType<SkeletonEntity> MOB_ENTITY_TYPE = EntityType.SKELETON;

    public SkeletonBucketItem(Settings settings) {
        super(settings);
    }
    ...
    public ActionResult useOnBlock(ItemUsageContext context) {
        ...
        if (!world.isClient) {
            ...
            // spawn the mob
            SkeletonEntity mob = spawn(MOB_ENTITY_TYPE, (ServerWorld)world, spawnPos, SpawnReason.BUCKET);
            if (mob != null) {
