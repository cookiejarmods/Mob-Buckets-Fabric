...
public class BlazeBucketItem extends Item {
    ...
    public static final EntityType<BlazeEntity> MOB_ENTITY_TYPE = EntityType.BLAZE;
    ...
    public ActionResult useOnBlock(ItemUsageContext context) {
        ...
        if (!world.isClient) {
            ...
            // spawn the mob
            BlazeEntity mob = spawn(MOB_ENTITY_TYPE, (ServerWorld)world, spawnPos, SpawnReason.BUCKET);
            if (mob != null) {
