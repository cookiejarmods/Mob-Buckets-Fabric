...
public class PiglinBucketItem extends Item {
    ...
    public static final EntityType<PiglinEntity> MOB_ENTITY_TYPE = EntityType.PIGLIN;
    ...
    public ActionResult useOnBlock(ItemUsageContext context) {
        ...
        if (!world.isClient) {
            ...
            // spawn the mob
            PiglinEntity mob = spawn(MOB_ENTITY_TYPE, (ServerWorld)world, spawnPos, SpawnReason.BUCKET);
            if (mob != null) {
