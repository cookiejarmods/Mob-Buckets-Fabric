...
public class SheepBucketItem extends Item {
    ...
    public static final EntityType<SheepEntity> MOB_ENTITY_TYPE = EntityType.SHEEP;
    ...
    public ActionResult useOnBlock(ItemUsageContext context) {
        ...
        if (!world.isClient) {
            ...
            // spawn the mob
            SheepEntity mob = spawn(MOB_ENTITY_TYPE, (ServerWorld)world, spawnPos, SpawnReason.BUCKET);
            if (mob != null) {
