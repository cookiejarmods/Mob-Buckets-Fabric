...
public class EvokerBucketItem extends Item {
    public static final String STORED_MOB = "stored_mob";
    public static final EntityType<EvokerEntity> MOB_ENTITY_TYPE = EntityType.EVOKER;

    public EvokerBucketItem(Settings settings) {
        super(settings);
    }
    ...
    public ActionResult useOnBlock(ItemUsageContext context) {
        ...
        if (!world.isClient) {
            ...
            // spawn the mob
            EvokerEntity mob = spawn(MOB_ENTITY_TYPE, (ServerWorld)world, spawnPos, SpawnReason.BUCKET);
            if (mob != null) {
