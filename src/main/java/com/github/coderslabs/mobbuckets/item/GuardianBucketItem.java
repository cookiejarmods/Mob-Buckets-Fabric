...
public class GuardianBucketItem extends Item {
    ...
    public static final EntityType<GuardianEntity> MOB_ENTITY_TYPE = EntityType.GUARDIAN;
    ...
    public ActionResult useOnBlock(ItemUsageContext context) {
        ...
        if (!world.isClient) {
            ...
            // spawn the mob
            GuardianEntity mob = spawn(MOB_ENTITY_TYPE, (ServerWorld)world, spawnPos, SpawnReason.BUCKET);
            if (mob != null) {
