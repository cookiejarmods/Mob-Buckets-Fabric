...
public class VexBucketItem extends Item {
    public static final String STORED_MOB = "stored_mob";
    public static final EntityType<VexEntity> MOB_ENTITY_TYPE = EntityType.VEX;

    public VexBucketItem(Settings settings) {
        super(settings);
    }
    ...
    public ActionResult useOnBlock(ItemUsageContext context) {
        ...
        if (!world.isClient) {
            ...
            // spawn the mob
            VexEntity mob = spawn(MOB_ENTITY_TYPE, (ServerWorld)world, spawnPos, SpawnReason.BUCKET);
            if (mob != null) {
