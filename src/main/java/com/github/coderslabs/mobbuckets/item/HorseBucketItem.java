...
public class HorseBucketItem extends Item {
    ...
    public static final EntityType<HorseEntity> MOB_ENTITY_TYPE = EntityType.HORSE;
    ...
    public ActionResult useOnBlock(ItemUsageContext context) {
        ...
        if (!world.isClient) {
            ...
            // spawn the mob
            HorseEntity mob = spawn(MOB_ENTITY_TYPE, (ServerWorld)world, spawnPos, SpawnReason.BUCKET);
            if (mob != null) {
