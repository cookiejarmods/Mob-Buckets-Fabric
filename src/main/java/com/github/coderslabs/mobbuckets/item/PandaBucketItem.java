...
public class PandaBucketItem extends Item {
    ...
    public static final EntityType<PandaEntity> MOB_ENTITY_TYPE = EntityType.PANDA;
    ...
    public ActionResult useOnBlock(ItemUsageContext context) {
        ...
        if (!world.isClient) {
            ...
            // spawn the mob
            PandaEntity mob = spawn(MOB_ENTITY_TYPE, (ServerWorld)world, spawnPos, SpawnReason.BUCKET);
            if (mob != null) {
