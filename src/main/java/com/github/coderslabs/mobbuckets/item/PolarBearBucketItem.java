...
public class PolarBearBucketItem extends Item {
    ...
    public static final EntityType<PolarBearEntity> MOB_ENTITY_TYPE = EntityType.POLAR_BEAR;
    ...
    public ActionResult useOnBlock(ItemUsageContext context) {
        ...
        if (!world.isClient) {
            ...
            // spawn the mob
            PolarBearEntity mob = spawn(MOB_ENTITY_TYPE, (ServerWorld)world, spawnPos, SpawnReason.BUCKET);
            if (mob != null) {
