...
public class SquidBucketItem extends Item {
    ...
    public static final EntityType<SquidEntity> MOB_ENTITY_TYPE = EntityType.SQUID;
    ...
    public ActionResult useOnBlock(ItemUsageContext context) {
        ...
        if (!world.isClient) {
            ...
            // spawn the mob
            SquidEntity mob = spawn(MOB_ENTITY_TYPE, (ServerWorld)world, spawnPos, SpawnReason.BUCKET);
            if (mob != null) {
