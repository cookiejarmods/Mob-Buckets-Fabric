...
public class CatBucketItem extends Item {
    ...
    public static final EntityType<CatEntity> MOB_ENTITY_TYPE = EntityType.CAT;
    ...
    public ActionResult useOnBlock(ItemUsageContext context) {
        ...
        if (!world.isClient) {
            ...
            // spawn the mob
            CatEntity mob = spawn(MOB_ENTITY_TYPE, (ServerWorld)world, spawnPos, SpawnReason.BUCKET);
            if (mob != null) {
