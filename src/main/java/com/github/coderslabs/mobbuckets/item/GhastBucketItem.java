...
public class GhastBucketItem extends Item {
    public static final String STORED_MOB = "stored_mob";
    public static final EntityType<GhastEntity> MOB_ENTITY_TYPE = EntityType.GHAST;

    public GhastBucketItem(Settings settings) {
        super(settings);
    }
    ...
    public ActionResult useOnBlock(ItemUsageContext context) {
        ...
        if (!world.isClient) {
            ...
            // spawn the mob
            GhastEntity mob = spawn(MOB_ENTITY_TYPE, (ServerWorld)world, spawnPos, SpawnReason.BUCKET);
            if (mob != null) {
