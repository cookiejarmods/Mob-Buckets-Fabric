...
public class RabbitBucketItem extends Item {
    ...
    public static final EntityType<RabbitEntity> MOB_ENTITY_TYPE = EntityType.RABBIT;
    ...
    public ActionResult useOnBlock(ItemUsageContext context) {
        ...
        if (!world.isClient) {
            ...
            // spawn the mob
            RabbitEntity mob = spawn(MOB_ENTITY_TYPE, (ServerWorld)world, spawnPos, SpawnReason.BUCKET);
            if (mob != null) {
