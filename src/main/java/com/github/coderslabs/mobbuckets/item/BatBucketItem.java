...
public class BatBucketItem extends Item {
    ...
    public static final EntityType<BatEntity> MOB_ENTITY_TYPE = EntityType.BAT;

    public BatBucketItem(Settings settings) {
        super(settings);
    }
    ...
    public ActionResult useOnBlock(ItemUsageContext context) {
        ...
        if (!world.isClient) {
            ...
            // spawn the mob
            BatEntity mob = spawn(MOB_ENTITY_TYPE, (ServerWorld)world, spawnPos, SpawnReason.BUCKET);
            if (mob != null) {
