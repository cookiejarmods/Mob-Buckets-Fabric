...
public class ShulkerBucketItem extends Item {
    public static final String STORED_MOB = "stored_mob";
    public static final EntityType<ShulkerEntity> MOB_ENTITY_TYPE = EntityType.SHULKER;

    public ShulkerBucketItem(Settings settings) {
        super(settings);
    }
    ...
    public ActionResult useOnBlock(ItemUsageContext context) {
        ...
        if (!world.isClient) {
            ...
            // spawn the mob
            ShulkerEntity mob = spawn(MOB_ENTITY_TYPE, (ServerWorld)world, spawnPos, SpawnReason.BUCKET);
            if (mob != null) {
