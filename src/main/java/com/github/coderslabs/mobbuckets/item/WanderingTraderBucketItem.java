...
public class WanderingTraderBucketItem extends Item {
    ...
    public static final EntityType<WanderingTraderEntity> MOB_ENTITY_TYPE = EntityType.WANDERING_TRADER;
    ...
    public ActionResult useOnBlock(ItemUsageContext context) {
        ...
        if (!world.isClient) {
            ...
            // spawn the mob
            WanderingTraderEntity mob = spawn(MOB_ENTITY_TYPE, (ServerWorld)world, spawnPos, SpawnReason.BUCKET);
            if (mob != null) {
