...
public class MooshroomBucketItem extends Item {
    ...
    public static final EntityType<MooshroomEntity> MOB_ENTITY_TYPE = EntityType.MOOSHROOM;
    ...
    public ActionResult useOnBlock(ItemUsageContext context) {
        ...
        if (!world.isClient) {
            ...
            // spawn the mob
            MooshroomEntity mob = spawn(MOB_ENTITY_TYPE, (ServerWorld)world, spawnPos, SpawnReason.BUCKET);
            if (mob != null) {
